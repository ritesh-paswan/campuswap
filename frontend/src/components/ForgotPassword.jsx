    ...
    <div className="cs-auth-page">
      <div className="cs-auth-box">
        ...
        {step === 'email' ? (
          ...
          <form onSubmit={handleReset}>
            <div className="cs-otp-box">
              ...
              <input
                className="cs-otp-input" type="text"
            ...
            <div className="cs-field">
              ...
              <input
                className="cs-input" type="password"
        ...
        <p className="cs-switch">
          <span className="cs-switch-link" onClick={onBack}>← Back to Sign in</span>
        </p>
      </div>
    </div>
  );
