...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  body { font-family: 'Inter', sans-serif; background: #080c14; color: #e2e8f0; min-height: 100vh; }
  .cs-app { min-height: 100vh; background: #080c14; }

  /* NAV */
  .cs-nav { position: sticky; top: 0; z-index: 100; background: rgba(8,12,20,0.85); backdrop-filter: blur(16px); border-bottom: 1px solid rgba(99,179,237,0.1); padding: 0 24px; }
  .cs-nav-inner { max-width: 1100px; margin: 0 auto; height: 56px; display: flex; align-items: center; justify-content: space-between; }
  .cs-logo { font-family: 'Space Grotesk', sans-serif; font-size: 1.3rem; font-weight: 700; background: linear-gradient(135deg, #63b3ed, #9f7aea); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; cursor: pointer; letter-spacing: -0.5px; }
  ...
  .cs-btn-nav-back { display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; background: rgba(99,179,237,0.08); color: #94a3b8; border: 1px solid rgba(99,179,237,0.12); border-radius: 8px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  .cs-btn-nav-back:hover { background: rgba(99,179,237,0.14); color: #e2e8f0; }
  .cs-btn-logout { padding: 6px 14px; background: rgba(239,68,68,0.1); color: #f87171; border: 1px solid rgba(239,68,68,0.2); border-radius: 8px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  .cs-btn-logout:hover { background: rgba(239,68,68,0.2); border-color: rgba(239,68,68,0.4); }
  .cs-btn-nav-login { padding: 6px 14px; background: rgba(59,130,246,0.1); color: #63b3ed; border: 1px solid rgba(59,130,246,0.2); border-radius: 8px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  .cs-btn-nav-login:hover { background: rgba(59,130,246,0.2); }
  .cs-btn-nav-signup { padding: 6px 14px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 8px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  .cs-btn-nav-signup:hover { opacity: 0.9; transform: translateY(-1px); }
  .cs-btn-inbox { position: relative; padding: 6px 14px; background: rgba(99,179,237,0.08); color: #94a3b8; border: 1px solid rgba(99,179,237,0.15); border-radius: 8px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; display: flex; align-items: center; gap: 6px; }
  ...
  .cs-unread-badge { position: absolute; top: -6px; right: -6px; background: #ef4444; color: #fff; font-size: 0.65rem; font-weight: 700; padding: 2px 5px; border-radius: 10px; min-width: 18px; text-align: center; line-height: 1.4; }

  /* PUSH PERMISSION BANNER */
  .cs-push-banner { background: rgba(59,130,246,0.06); border: 1px solid rgba(59,130,246,0.15); border-radius: 14px; padding: 14px 20px; margin-bottom: 20px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px; }
  .cs-push-banner-text { font-size: 0.875rem; color: #64748b; }
  .cs-push-banner-text strong { color: #94a3b8; }
  .cs-btn-push-enable { padding: 7px 16px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 8px; font-size: 0.82rem; font-weight: 600; cursor: pointer; font-family: 'Inter', sans-serif; }
  .cs-btn-push-dismiss { padding: 7px 12px; background: transparent; color: #475569; border: none; font-size: 0.8rem; cursor: pointer; font-family: 'Inter', sans-serif; }

  /* HERO */
  .cs-hero { background: #080c14; padding: 70px 24px 50px; text-align: center; position: relative; overflow: hidden; }
  .cs-hero::before { content: ''; position: absolute; top: -100px; left: 50%; transform: translateX(-50%); width: 600px; height: 400px; background: radial-gradient(ellipse, rgba(59,130,246,0.08) 0%, transparent 70%); pointer-events: none; }
  .cs-hero-badge { display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; background: rgba(59,130,246,0.08); border: 1px solid rgba(59,130,246,0.2); border-radius: 20px; font-size: 0.75rem; font-weight: 600; color: #63b3ed; letter-spacing: 0.05em; text-transform: uppercase; margin-bottom: 24px; }
  .cs-hero-title { font-family: 'Space Grotesk', sans-serif; font-size: clamp(2rem, 5vw, 3.2rem); font-weight: 700; color: #f1f5f9; line-height: 1.15; letter-spacing: -1px; margin-bottom: 20px; max-width: 700px; margin-left: auto; margin-right: auto; }
  .cs-hero-title span { background: linear-gradient(135deg, #63b3ed, #9f7aea); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
  ...
  .cs-btn-hero-primary { padding: 13px 28px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 12px; font-size: 0.95rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; box-shadow: 0 0 24px rgba(99,102,241,0.3); }
  .cs-btn-hero-primary:hover { transform: translateY(-2px); box-shadow: 0 0 36px rgba(99,102,241,0.5); }
  .cs-btn-hero-secondary { padding: 13px 28px; background: rgba(255,255,255,0.04); color: #94a3b8; border: 1px solid rgba(99,179,237,0.15); border-radius: 12px; font-size: 0.95rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  ...
  /* MAIN */
  .cs-main { max-width: 1100px; margin: 0 auto; padding: 24px; }
  ...
  .cs-btn-sell { padding: 9px 20px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 10px; font-size: 0.875rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; box-shadow: 0 0 20px rgba(99,102,241,0.3); }
  ...
  /* INPUTS */
  .cs-input { width: 100%; padding: 11px 14px; background: #0a0f1a; border: 1px solid rgba(99,179,237,0.15); border-radius: 10px; color: #e2e8f0; font-size: 0.9rem; font-family: 'Inter', sans-serif; transition: border-color 0.2s, box-shadow 0.2s; outline: none; }
  ...
  .cs-btn-primary { width: 100%; padding: 13px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 10px; font-size: 0.95rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; box-shadow: 0 0 20px rgba(99,102,241,0.25); }
  ...
  .cs-product-card { background: #0f1623; border: 1px solid rgba(99,179,237,0.08); border-radius: 14px; overflow: hidden; cursor: pointer; transition: all 0.25s; }
  ...
  .cs-btn-delete:hover { background: rgba(239,68,68,0.2); }
  ...
  .cs-btn-prompt-signup { padding: 7px 16px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 8px; font-size: 0.82rem; font-weight: 600; cursor: pointer; font-family: 'Inter', sans-serif; }
  ...
  .cs-btn-message { width: 100%; padding: 14px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 12px; font-size: 0.95rem; font-weight: 700; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; display: flex; align-items: center; justify-content: center; gap: 10px; box-shadow: 0 0 24px rgba(99,102,241,0.25); }
  ...
  .cs-conv-card { background: #0f1623; border: 1px solid rgba(99,179,237,0.08); border-radius: 14px; padding: 14px 18px; display: flex; align-items: center; gap: 14px; cursor: pointer; transition: all 0.2s; }
  ...
  /* CHAT */
  .cs-chat-wrap { display: flex; flex-direction: column; height: calc(100vh - 56px); max-width: 1100px; margin: 0 auto; padding: 0 24px; }
  .cs-chat-topbar { display: flex; align-items: center; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(99,179,237,0.08); flex-shrink: 0; }
  ...
  .cs-chat-messages { flex: 1; overflow-y: auto; padding: 12px 0; display: flex; flex-direction: column; gap: 2px; }
  ...
  .cs-btn-send { padding: 10px 18px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 10px; font-size: 0.875rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  ...
  @media (max-width: 640px) {
    ...
    .cs-push-banner { flex-direction: column; }
  }
`;
...
function App() {
  ...
  // Show push banner after login if permission not yet granted
  useEffect(() => {
    ...
    <nav className="cs-nav">
      <div className="cs-nav-inner">
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          {backAction && (
            <button className="cs-btn-nav-back" onClick={backAction}>← Back</button>
          )}
            ...
            {selectedProduct ? (
              ...
              <>
                ...
                <main className="cs-main">
                  ...
                  {showPushBanner && (
                    <div className="cs-push-banner">
                      <div className="cs-push-banner-text">
                        <strong>🔔 Enable notifications</strong> — get notified when someone messages you, even when the app is closed.
                      </div>
                      <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                        <button className="cs-btn-push-enable" onClick={handleEnablePush}>Enable</button>
                        <button className="cs-btn-push-dismiss" onClick={handleDismissPush}>Not now</button>
                      </div>
                    </div>
                  )}
                  ...
                  <ProductList products={products} loading={productsLoading} onProductClick={(product) => setSelectedProduct(product)} onProductDeleted={fetchProducts} isLoggedIn={!!user} />
                </main>
              </>
            )}
          </>
