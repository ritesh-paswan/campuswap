...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cs-greeting { font-size: 0.875rem; color: #94a3b8; font-weight: 500; }
  .cs-greeting span { color: #63b3ed; font-weight: 600; }
  .cs-btn-logout {
    padding: 7px 16px; background: rgba(239,68,68,0.1); color: #f87171;
  ...
  .cs-btn-nav-login {
    padding: 7px 16px; background: rgba(59,130,246,0.1); color: #63b3ed;
    border: 1px solid rgba(59,130,246,0.2); border-radius: 8px;
    font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif;
  }
  .cs-btn-nav-login:hover { background: rgba(59,130,246,0.2); }
  .cs-btn-nav-signup {
    padding: 7px 16px; background: linear-gradient(135deg, #3b82f6, #8b5cf6);
  ...
  /* HERO */
  .cs-hero {
    background: #080c14; padding: 80px 24px 60px;
  ...
  .cs-hero-actions { display: flex; gap: 12px; justify-content: center; flex-wrap: wrap; margin-bottom: 56px; }
  .cs-btn-hero-primary {
  ...
  .cs-hero-stats { display: flex; justify-content: center; gap: 40px; flex-wrap: wrap; padding-top: 40px; border-top: 1px solid rgba(99,179,237,0.08); }
  ...
  /* MARKETPLACE HEADER */
  .cs-market-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 28px; flex-wrap: wrap; gap: 12px; }
  .cs-market-title { font-family: 'Space Grotesk', sans-serif; font-size: 1.6rem; font-weight: 700; color: #f1f5f9; letter-spacing: -0.5px; }
  ...
  /* AUTH */
  .cs-auth-page { min-height: calc(100vh - 64px); display: flex; align-items: center; justify-content: center; padding: 40px 20px; }
  .cs-auth-box { width: 100%; max-width: 420px; background: #0f1623; border: 1px solid rgba(99,179,237,0.1); border-radius: 20px; padding: 40px; box-shadow: 0 25px 60px rgba(0,0,0,0.4); }
  ...
  /* OTP */
  .cs-otp-box { background: rgba(59,130,246,0.05); border: 1px solid rgba(59,130,246,0.2); border-radius: 12px; padding: 20px; margin-bottom: 20px; }
  ...
  /* PRODUCT FORM */
  .cs-form-card { background: #0f1623; border: 1px solid rgba(99,179,237,0.08); border-radius: 16px; padding: 28px; margin-bottom: 32px; }
  .cs-form-title { font-family: 'Space Grotesk', sans-serif; font-size: 1.1rem; font-weight: 700; color: #f1f5f9; margin-bottom: 24px; display: flex; align-items: center; gap: 10px; }
  ...
  /* SEARCH & FILTER */
  .cs-search-wrap { background: #0f1623; border: 1px solid rgba(99,179,237,0.08); border-radius: 16px; padding: 20px; margin-bottom: 24px; }
  .cs-search-wrap-inner { position: relative; }
  .cs-search-input { width: 100%; padding: 12px 16px 12px 44px; background: #0a0f1a; border: 1px solid rgba(99,179,237,0.15); border-radius: 10px; color: #e2e8f0; font-size: 0.9rem; font-family: 'Inter', sans-serif; outline: none; transition: border-color 0.2s, box-shadow 0.2s; }
  ...
  .cs-search-icon { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: #475569; font-size: 1rem; pointer-events: none; }
  .cs-filters { display: flex; gap: 8px; flex-wrap: wrap; margin-top: 16px; }
  .cs-filter-btn { padding: 6px 14px; border-radius: 20px; border: 1px solid rgba(99,179,237,0.15); background: transparent; color: #64748b; font-size: 0.8rem; font-weight: 500; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  ...
  .cs-listings-count { padding: 3px 10px; background: rgba(59,130,246,0.1); border: 1px solid rgba(59,130,246,0.2); border-radius: 20px; font-size: 0.75rem; font-weight: 600; color: #63b3ed; }

  /* PRODUCT GRID */
  .cs-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 20px; }
  .cs-product-card { background: #0f1623; border: 1px solid rgba(99,179,237,0.08); border-radius: 16px; overflow: hidden; cursor: pointer; transition: all 0.25s; position: relative; }
  ...
  .cs-product-img-placeholder { width: 100%; height: 190px; background: #0a0f1a; display: flex; align-items: center; justify-content: center; color: #1e293b; font-size: 2.5rem; }
  ...
  .cs-product-title { font-family: 'Space Grotesk', sans-serif; font-size: 0.95rem; font-weight: 600; color: #e2e8f0; margin-bottom: 6px; line-height: 1.3; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
  .cs-product-desc { font-size: 0.8rem; color: #475569; line-height: 1.5; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
  .cs-product-footer { display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; border-top: 1px solid rgba(99,179,237,0.06); }
  ...
  .cs-btn-delete { padding: 5px 12px; background: rgba(239,68,68,0.1); color: #f87171; border: 1px solid rgba(239,68,68,0.2); border-radius: 6px; font-size: 0.75rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  .cs-btn-delete:hover { background: rgba(239,68,68,0.2); border-color: rgba(239,68,68,0.4); }

  /* LOGIN PROMPT */
  .cs-login-prompt { background: rgba(59,130,246,0.06); border: 1px solid rgba(59,130,246,0.15); border-radius: 14px; padding: 20px 24px; margin-bottom: 28px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px; }
  ...
  .cs-btn-prompt-login { padding: 8px 18px; background: transparent; color: #63b3ed; border: 1px solid rgba(59,130,246,0.3); border-radius: 8px; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  .cs-btn-prompt-login:hover { background: rgba(59,130,246,0.1); }
  .cs-btn-prompt-signup { padding: 8px 18px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 8px; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  ...
  /* DETAIL */
  .cs-btn-back { display: inline-flex; align-items: center; gap: 8px; padding: 9px 18px; background: rgba(99,179,237,0.08); color: #94a3b8; border: 1px solid rgba(99,179,237,0.12); border-radius: 10px; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: all 0.2s; margin-bottom: 28px; font-family: 'Inter', sans-serif; }
  ...
  .cs-detail-img { width: 100%; max-height: 420px; object-fit: contain; border-radius: 16px; border: 1px solid rgba(99,179,237,0.08); background: #0a0f1a; }
  ...
  .cs-detail-desc { background: #0a0f1a; border: 1px solid rgba(99,179,237,0.08); border-radius: 12px; padding: 16px; color: #94a3b8; font-size: 0.9rem; line-height: 1.7; margin-bottom: 28px; flex: 1; }
  .cs-detail-seller { padding: 14px 16px; background: rgba(99,179,237,0.04); border: 1px solid rgba(99,179,237,0.08); border-radius: 12px; font-size: 0.85rem; color: #64748b; margin-bottom: 16px; }
  ...
  /* SORT */
  .cs-sort-select { padding: 6px 12px; background: #0a0f1a; border: 1px solid rgba(99,179,237,0.15); border-radius: 8px; color: #94a3b8; font-size: 0.8rem; font-family: 'Inter', sans-serif; outline: none; cursor: pointer; }
  .cs-sort-select:focus { border-color: #3b82f6; }

  /* TIME AGO */
  .cs-product-time { font-size: 0.7rem; color: #bfc2c6; font-weight: 500; }

  /* SHARE */
  .cs-btn-share { padding: 4px 10px; background: rgba(99,179,237,0.08); color: #64748b; border: 1px solid rgba(99,179,237,0.12); border-radius: 6px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; }
  .cs-btn-share:hover { background: rgba(99,179,237,0.15); color: #94a3b8; }

  /* INBOX PAGE */
  .cs-inbox-header { margin-bottom: 24px; }
  .cs-inbox-title { font-family: 'Space Grotesk', sans-serif; font-size: 1.6rem; font-weight: 700; color: #f1f5f9; letter-spacing: -0.5px; }
  .cs-conv-list { display: flex; flex-direction: column; gap: 12px; }
  .cs-conv-card {
  ...
  .cs-conv-img { width: 52px; height: 52px; border-radius: 10px; object-fit: cover; background: #0a0f1a; flex-shrink: 0; }
  .cs-conv-img-placeholder { width: 52px; height: 52px; border-radius: 10px; background: #0a0f1a; display: flex; align-items: center; justify-content: center; font-size: 1.4rem; flex-shrink: 0; }
  .cs-conv-body { flex: 1; min-width: 0; }
  .cs-conv-product { font-size: 0.75rem; color: #8b5cf6; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 2px; }
  .cs-conv-name { font-family: 'Space Grotesk', sans-serif; font-size: 0.95rem; font-weight: 600; color: #e2e8f0; margin-bottom: 4px; }
  .cs-conv-last { font-size: 0.8rem; color: #475569; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
  .cs-conv-meta { display: flex; flex-direction: column; align-items: flex-end; gap: 6px; flex-shrink: 0; }
  .cs-conv-time { font-size: 0.72rem; color: #334155; }
  .cs-conv-unread-dot { width: 8px; height: 8px; background: #3b82f6; border-radius: 50%; }

  /* CHAT WINDOW */
  .cs-chat-wrap { display: flex; flex-direction: column; height: calc(100vh - 140px); }
  .cs-chat-header { display: flex; align-items: center; gap: 14px; padding-bottom: 20px; margin-bottom: 0; border-bottom: 1px solid rgba(99,179,237,0.08); }
  .cs-chat-product-img { width: 44px; height: 44px; border-radius: 8px; object-fit: cover; background: #0a0f1a; }
  .cs-chat-product-img-placeholder { width: 44px; height: 44px; border-radius: 8px; background: #0a0f1a; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; }
  .cs-chat-header-info { flex: 1; }
  .cs-chat-header-title { font-family: 'Space Grotesk', sans-serif; font-size: 1rem; font-weight: 600; color: #f1f5f9; }
  .cs-chat-header-sub { font-size: 0.78rem; color: #64748b; margin-top: 2px; }
  .cs-chat-messages { flex: 1; overflow-y: auto; padding: 20px 0; display: flex; flex-direction: column; gap: 12px; }
  ...
  .cs-msg-sender { font-size: 0.7rem; color: #475569; margin-bottom: 4px; font-weight: 500; }
  .cs-msg-time { font-size: 0.68rem; color: #334155; margin-top: 4px; }
  .cs-chat-input-wrap { padding-top: 16px; border-top: 1px solid rgba(99,179,237,0.08); display: flex; gap: 10px; }
  .cs-chat-input { flex: 1; padding: 12px 16px; background: #0a0f1a; border: 1px solid rgba(99,179,237,0.15); border-radius: 12px; color: #e2e8f0; font-size: 0.9rem; font-family: 'Inter', sans-serif; outline: none; transition: border-color 0.2s; }
  .cs-chat-input:focus { border-color: #3b82f6; }
  .cs-chat-input::placeholder { color: #475569; }
  .cs-btn-send { padding: 12px 20px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: #fff; border: none; border-radius: 12px; font-size: 0.9rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; white-space: nowrap; }
  .cs-btn-send:hover:not(:disabled) { transform: translateY(-1px); }
  .cs-btn-send:disabled { opacity: 0.5; cursor: not-allowed; }
  .cs-chat-empty { display: flex; flex-direction: column; align-items: center; justify-content: center; flex: 1; color: #334155; gap: 12px; }
  .cs-chat-empty-icon { font-size: 2.5rem; }
...
function App() {
  ...
  // Poll unread count every 15 seconds when logged in
  useEffect(() => {
    if (!user) return;
    fetchUnreadCount();
  ...
  if (view === 'login') return (
    <>
      ...
      <div className="cs-app">
        <nav className="cs-nav"><div className="cs-nav-inner">
            ...
            <div className="cs-nav-right">
              {user ? (
                <>
                  ...
                  <button
                    className={`cs-btn-inbox ${view === 'inbox' || view === 'chat' ? 'active' : ''}`}
